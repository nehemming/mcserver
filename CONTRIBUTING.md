...
Welcome and thank you for considering contributing to the mcserver project.
...
We welcome contributions from the open source community.  There are many ways to contribute, from writing code samples, improving the documentation, submitting bug reports and feature requests to writing code which can be incorporated into the SDK itself. This section guides you through submitting a contribution to the mcserver.
...
Pull requests are reviewed on a regular basis and will give feedback on the corresponding issue in the repo. After feedback has been given it is expected that you respond within two weeks, the pull request may be closed if it does not show any signs of activity. 
